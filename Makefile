PROJECT_NAME := Pulumi cr Resource Provider

PACK             := cr
PACKDIR          := sdk
PROJECT          := github.com/daichitakahashi/pulumi-cr
NODE_MODULE_NAME := @daichitakahashi/cr
NUGET_PKG_NAME   := daichitakahashi.cr
